...
interface TorneoClientProps {
  initialEventsByMatch: Record<string, MatchEvent[]>;
}
...
function eventHasMember(
  event: MatchEvent
): event is MatchEvent & { member: string } {
...
export default function TorneoClient({
  initialEventsByMatch,
}: TorneoClientProps) {
